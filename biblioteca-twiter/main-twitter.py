'''
Falta criar uma documentação dos requisitos funcionais do sistema.
Dá um import, passa os parametros e fica pythonico.....
E assim você cria uma classe para reutilizar ao dia a dia.
'''
